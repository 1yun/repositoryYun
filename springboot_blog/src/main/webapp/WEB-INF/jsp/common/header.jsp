				...
				<ul class="site-nav topmenu">
					...
					<li class="dropdown"><a class="dropdown-toggle"
						...
						<ul class="dropdown-menu header-topbar-dropdown-menu">
							<li><a data-toggle="modal" data-target="#WeChat"
								rel="nofollow"><i class="fa fa-weixin"></i> 微信</a></li>
							<li><a href="#" rel="nofollow"><i class="fa fa-weibo"></i>
									微博</a></li>
							<li><a data-toggle="modal" data-target="#areDeveloping"
								rel="nofollow"><i class="fa fa-rss"></i> RSS</a></li>
						</ul></li>
				</ul>
				<!-- +号在el表达式只能做计算    需要用concat进行连接       抑制登录窗口弹出-->
				<a data-toggle="modal" data-target="${loginedUser==null?'#loginModal':''}" class="login"
					rel="nofollow">${loginedUser==null?'Hi,请登录':'欢迎'.concat(loginedUser.cnName) }</a>&nbsp;&nbsp;<a href="javascript:;"
      ...
      <div class="collapse navbar-collapse" id="header-navbar">
        <ul class="nav navbar-nav navbar-right">
          ...
          <c:forEach items="${cList}" var="cate">
          	<li><a href="category?id=${cate.id}&name=${cate.name}">${cate.name }</a></li>
          </c:forEach>
        </ul>
