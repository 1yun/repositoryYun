	      ...
	      <a class="focus" href="article?id=${a.id}" title="">
	        ...
	        <p class="meta">
	          ...
	          <span class="views"><i class="glyphicon glyphicon-eye-open"></i> 共${a.readcnt}人围观</span>
	           <a class="comment" href="article.html#comment"><i class="glyphicon glyphicon-comment"></i> 0个不明物体</a></p>
	        ...
	        <script type="text/javascript">
	        	var p=p${a.id};
	        	var d=d${a.id};
	        	/*innerText 只获取html标签中的内容   innerHTML 会把标签也获取出来  */
	        	p.innerText=d.innerText.substring(0,150);
	        	$('#p'+${a.id}+'').find('br').remove();
	        </script>
	      </article>
      </c:forEach>
