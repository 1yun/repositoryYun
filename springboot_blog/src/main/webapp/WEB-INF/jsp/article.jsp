  ...
  <div class="content-wrap">
    <div class="content">
				<header class="article-header">
					...
					<div class="article-meta">
						<span class="item article-meta-time"> <time class="time"
							...
							class="glyphicon glyphicon-list"></i> <a href="program" title="">${article.category.name }</a></span>
						<span class="item article-meta-views" data-toggle="tooltip"
							data-placement="bottom" title="查看：${article.readcnt }"><i
							class="glyphicon glyphicon-eye-open"></i> 共${article.readcnt}此阅读</span> <span
      ...
      <div class="relates">
        ...
        <ul>
        <c:forEach items="${relativeList}" var="a">
